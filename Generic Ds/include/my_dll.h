...
#define __MY_DLL__H
#include"my_common.h"
typedef struct __$__my_dll_node
{
void *ptr;
struct __$__my_dll_node *next;
struct __$__my_dll_node *previous;
}DoublyLinkedListNode;

typedef struct __$__my_dll
{
struct __$__my_dll_node *start;
struct __$__my_dll_node *end;
int size;
}DoublyLinkedList;
...
typedef struct __$__my_reverse_iterator
{
DoublyLinkedListNode *node;
